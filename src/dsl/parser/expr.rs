use super::*;
use crate::dsl::syntax::{Part, Template};
...
#[cfg(test)]
mod tests {
    use crate::dsl::parser::test_support::parse_program;
    use crate::dsl::syntax::Part;

    #[test]
    fn test_parse_literal_template() {
        let prog = parse_program("var x = (hello);").unwrap();
        match &prog.top_level_items[0] {
            crate::dsl::TopLevel::Stmt(crate::dsl::Stmt::Var { value, .. }) => {
