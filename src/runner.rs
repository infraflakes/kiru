...
///
/// When this is set, project-body `var shell` commands run in the project's
/// directory in the filesystem root[^1] rather than in a temporary directory.
///
/// [^1]: `project.dir` / the project's root kira file location.
